						...
						<AlertDialog.Root bind:open={disciplineDialogOpen}>
							...
							<AlertDialog.Content>
								...
								<AlertDialog.Footer>
									...
									<AlertDialog.Action onclick={async () => await deleteDiscipline({ challengeId: challenge.id, disciplineId: d.id })} class={buttonVariants({ variant: 'destructive' })}>Continue</AlertDialog.Action>
								</AlertDialog.Footer>
							</AlertDialog.Content>
						</AlertDialog.Root>
					</ClubAdmin>
